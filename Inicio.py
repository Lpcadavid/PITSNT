...
with col1:
    st.image("./static/Lina.jpeg", width=200)  # Reemplaza con la ruta de la foto
    st.write("**Lina Patricia Cadavid**")
    st.write("Estudiante Nuevas Tecnologías")

with col2:
    st.image("./static/Carol.jpeg", width=200)  # Reemplaza con la ruta de la foto
    st.write("**Carol Eliana Gonzalez**")
    st.write("Estudiante Nuevas Tecnologías")

with col3:
    st.image("./static/Jose.jpeg", width=200)  # Reemplaza con la ruta de la foto
    st.write("**José Castro Molina**")
    st.write("Estudiante Nuevas Tecnológias")

with col2:
    st.image("./static/Roi.jpeg", width=200)  # Reemplaza con la ruta de la foto
    st.write("**Roicer Romero**")
    st.write("Estudiante Nuevas Tecnológias")

with col1:
    st.image("./static/Jero.jpeg", width=200)  # Reemplaza con la ruta de la foto
    st.write("**Jeronimo**")
    st.write("Estudiante Nuevas Tecnológias")
